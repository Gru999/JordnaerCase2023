...
namespace JordnærCase2023.Services
{
    public class MemberService : Connection, IMemberService
    {
        ...
        private string updateSql = "update Member " + 
            "set Member_Name = @Name, Member_Img = @Image, Member_Phone = @Phone, " + 
            "Member_Email = @Email, Member_Password = @Password, Member_SanitationCourse = @SanitationCourse, " + 
            "Member_Admin = @Admin where Member_ID = @ID";
